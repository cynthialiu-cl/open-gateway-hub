...
var APP_DATA = {
  ...
  camaraAPIs:[
    ...
    {name:"Sim Swap",desc:"检测 SIM 卡近期是否被更换",status:"Stable",version: "2026-09-01",releaseTag:"r3.2",category:"认证与反欺诈",launchMarkets:40,camaraUrl:"https://camaraproject.org/sim-swap/"},
    {name:"Device Status",desc:"设备在线/漫游/离线状态查询",status:"Stable",version: "2026-09-01",releaseTag:"r3.2",category:"设备信息",launchMarkets:20,camaraUrl:"https://github.com/camaraproject/DeviceStatus"},
    {name:"Device Roaming Status",desc:"设备漫游状态及所在国家",status:"Stable",version: "2026-09-01",releaseTag:"r3.2",category:"设备信息",launchMarkets:18,camaraUrl:"https://camaraproject.org/device-roaming-status/"},
    {name:"Device Reachability Status",desc:"设备是否可通过 SMS/数据到达",status:"Stable",version: "2026-09-01",releaseTag:"r3.2",category:"设备信息",launchMarkets:15,camaraUrl:"https://camaraproject.org/device-reachability-status/"},
    ...
    {name:"One Time Password SMS",desc:"标准化 OTP 短信发送",status:"Stable",version: "2026-09-01",releaseTag:"r2.2",category:"认证与反欺诈",launchMarkets:25,camaraUrl:"https://camaraproject.org/one-time-password-sms/"},
    ...
    {name:"Call Forwarding Signal",desc:"呼叫转移状态检测(反欺诈)",status:"Stable",version: "2026-09-01",releaseTag:"r3.2",category:"认证与反欺诈",launchMarkets:6,camaraUrl:"https://camaraproject.org/call-forwarding-signal/"},
    ...
    {name:"Simple Edge Discovery",desc:"边缘计算节点发现与路由",status:"Stable",version: "2026-09-01",releaseTag:"r3.2",category:"边缘计算",launchMarkets:3,camaraUrl:"https://camaraproject.org/simple-edge-discovery/"},
    ...
    {name:"QoS Booking",desc:"预约特定时间地点的网络质量保障",status:"Beta",version: "2026-09-01",releaseTag:"Beta",category:"网络质量",launchMarkets:1,camaraUrl:"https://camaraproject.org/qos-booking/"},
    {name:"Blockchain Public Address",desc:"手机号关联区块链地址(DID)",status:"Stable",version: "2026-09-01",releaseTag:"r3.2",category:"计费与支付",launchMarkets:1,camaraUrl:"https://camaraproject.org/blockchain-public-address/"},
    ...
    {name:"Number Recycling",desc:"手机号是否被回收重新分配",status:"Stable",version: "2026-09-01",releaseTag:"r3.2",category:"认证与反欺诈",launchMarkets:2,camaraUrl:"https://camaraproject.org/number-recycling/"},
